...
class ProductDiscountService:
    ...
    def create_discount(self, discount: ProductDiscountSchema):
        payment_method = self.product_discount_repository.get_payment_method_id(payment_method_id=discount.payment_method_id)
        ...
        self.payment_method_repository.create(ProductDiscount(**discount.dict()))
